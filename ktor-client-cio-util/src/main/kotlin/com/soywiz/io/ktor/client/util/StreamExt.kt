...
fun InputStream.readS32_be(): Int = (this.read() shl 24) or (this.read() shl 16) or (this.read() shl 8) or (this.read() shl 0)
...
fun InputStream.readS32_le(): Int = (this.read() shl 0) or (this.read() shl 8) or (this.read() shl 16) or (this.read() shl 24)
...
fun OutputStream.writeStringz(str: String, charset: Charset = UTF8) {
