...
object AmazonAuth {
    ...
    object V1 {
        ...
        fun macProcessStringsB64(key: String, algo: String, data: String): String =
            Base64.getEncoder().encodeToString(macProcess(key.toByteArray(), algo, data.toByteArray()))
    ...
    object V4 {
        ...
        fun HmacSHA256(data: String, key: ByteArray): ByteArray = HMAC(data.toByteArray(Charsets.UTF_8), key)
