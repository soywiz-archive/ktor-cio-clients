...
fun <T : Any> KProperty1<T, *>.DESC() =
    OrderSpec<T>(this to OrderDir.DESC)

fun <T : Any> KProperty1<T, *>.ASC() =
    OrderSpec<T>(this to OrderDir.ASC)

fun <T : Any> KProperty1<T, *>.ORDER(order: OrderDir? = null) =
    OrderSpec<T>(this to order)
