...
object MongoDBQueryBuilder {
    ...
    infix fun BsonDocument.and(other: BsonDocument): BsonDocument =
        and(this, other)

    infix fun BsonDocument.or(other: BsonDocument): BsonDocument =
        or(this, other)

    infix fun BsonDocument.nor(other: BsonDocument): BsonDocument =
        nor(this, other)
...
inline fun mongoQuery(generate: MongoDBQueryBuilder.() -> BsonDocument): BsonDocument = generate(
    MongoDBQueryBuilder
)
